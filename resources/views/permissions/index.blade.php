              ...
              <div class="card-header">
                <div class="row d-flex justify-content-end">
                  <div class="col-sm-4 col-lg-3 col-md-6">
                    <button type="button" class="btn btn-success float-end" data-bs-toggle="modal" data-bs-target="#createRoleModal"><i class="fas fa-plus"></i> Create Permissions</button>
                  </div>
                </div>
              </div>
              <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="description" class="form-control @error('description')
                        is-invalid
                    @enderror" cols="30" rows="10" placeholder="Permission Description"></textarea>
                    @error('description')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
